...
class AddCarwashIdPage extends StatefulWidget {
  @override
  _AddCarwashIdPageState createState() => _AddCarwashIdPageState();
}

class _AddCarwashIdPageState extends State<AddCarwashIdPage> {
  @override
